...
unsafe impl Identify for ComponentName1 {
    const GUID: Guid = guid!("107a772c-d5e1-11d4-9a46-0090273fc14d");
}
...
unsafe impl Identify for ComponentName2 {
    const GUID: Guid = guid!("6a7a5cff-e8d9-4f70-bada-75ab3025ce14");
}
