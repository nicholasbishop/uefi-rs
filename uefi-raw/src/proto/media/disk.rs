...
unsafe impl Identify for DiskIo {
    const GUID: Guid = guid!("ce345171-ba0b-11d2-8e4f-00a0c969723b");
}
...
unsafe impl Identify for DiskIo2 {
    const GUID: Guid = guid!("151c8eae-7f2c-472c-9e54-9828194f6a88");
}
