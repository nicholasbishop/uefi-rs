...
pub fn run_qemu(arch: UefiArch, opt: &QemuOpt) -> Result<()> {
    ...
    // Enable workaround for a bug in old versions of QEMU. This allows us to
    // use modern releases of edk2 (anything newer than edk2-stable202211)
    // without requiring QEMU 8+. See also https://github.com/tianocore/edk2/pull/3935.
    cmd.args([
        "-fw_cfg",
