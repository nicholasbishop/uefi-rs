...
use uefi::proto::media::file::{FileAttribute, FileInfo, FileInfoCreationError};
use uefi::table::runtime::{Daylight, Time, TimeParams};
use uefi::{cstr16, CString16, Guid, Identify, Result, Status};
use uefi_raw::protocol::media::{FileProtocol, SimpleFileSystemProtocol};
...
extern "efiapi" fn get_position(this: *mut FileProtocol, position: *mut u64) -> Status {
    Status::SUCCESS
}
